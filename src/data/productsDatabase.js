...
const productsDatabase = [
  ...
  { id: 'flu-ab', category: ['b2b', 'b2c'], subCat: 'Infectious', image: '/DSC_2098.JPG', img2: '/LabOnTime Device.jpg', isProfessionalOnly: false,
    title: { he: 'Influenza A+B (פורמט פטנט - בדיקת שפעת A+B)', en: 'Influenza A+B Rapid Test (Patented Device)', de: 'Influenza A+B Schnelltest (Patentierte Testvorrichtung)', fr: 'Test Rapide Grippe A+B (Dispositif Breveté)', ru: 'Грипп A+B', ar: 'الإنفلونزا A+B' },
    shortDesc: { he: 'ערכה מהירה לגילוי מוקדם של שפעת עונתית A+B (ברקוד: 7290013882165 / מק"ט: 51088). מחקר קליני ב-Heliyon הוכיח 100% ספציפיות.', en: 'Rapid test for seasonal flu A+B in official product box & integrated pen device (Barcode: 7290013882165).', de: 'Schnelltest für saisonale Grippe A+B im patentierten Stiftformat (Barcode: 7290013882165).', fr: 'Test rapide pour la grippe saisonnière A+B au format stylo breveté (Code-barres: 7290013882165).' },
    specs: { sensitivity: '75.7%', specificity: '100%', time: '10 Min', barcode: '7290013882165', validation: 'Heliyon 2024' }
  },
