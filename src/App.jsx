...
const translations = {
  ...
  ar: {
    ...
    tech: { title: 'منصة "صفر-خطوات"', desc: 'جهاز مدمج يمنع نقل السوائل المفتوحة تمامًا لحماية الطاقم الطبي.', s1Title: 'مسحة وجهاز مدمج', s1Desc: 'المسحة جزء لا يتجزأ من الجهاز. لا حاجة لأدوات إضافية.', s2Title: 'أنبوب استخراج ذكي', s2Desc: 'المواد الكيميائية مختلطة ומغلقة مسبقًا.', s3Title: 'نظام مغلق تمامًا', s3Desc: 'بمجرد إدخال المسحة، يتم قفلها للأبد.', ecoBadge: 'نظام بيئي صحي', ecoTitle: 'التوثيق الرقمي والذكاء الاصطناعي', ecoDesc: 'ربط مباشر للفحص المنزلي بالملف الطبي للمريض.', eco1: 'تشفير البيانات (GDPR)', eco2: 'دقة قراءة 97٪ (AI)', eco3: 'تكامل مباشر EMR' },
...
const productsDatabase = [
  ...
  { id: 'micro-albumin', category: 'b2b', subCat: 'Urine', image: 'Placeholder_Urine',
    title: { he: 'Micro-Albumin Rapid Test', en: 'Micro-Albumin Rapid Test', ru: 'Тест на Микроальбумин', ar: 'اختبار الألبومين הדقيق' },
